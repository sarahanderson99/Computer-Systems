...
/* these return a random time which is used to set the time each passenger takes to make each of these steps;  these times are set into the corresponding event before it is scheduled. */
double time_arrive();
