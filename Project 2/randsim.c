...
/* this uses log() from the math library, which might need the library *//* linked in with -lm on the compile command line */
#include <stdlib.h>
#include <math.h>
#include "randsim.h"
/* NOTE TO PROGRAMMERS - you MUST put a function prototype in your code */
/* for each of the functions you plan to call. *//* not used in this version, values must be passed in */
//#if 0
...
double rand_gas_full(double mean, double std)
{
	static int iset = 0;
	static double gset;
